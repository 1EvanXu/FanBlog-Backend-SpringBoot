...
//    }
     ...
     */
    public static BlogJSONResult formatToPojo(String jsonData, Class<?> clazz) {
        try {
            if (clazz == null) {
                return MAPPER.readValue(jsonData, BlogJSONResult.class);
            }
     ...
     */
    public static BlogJSONResult format(String json) {
        try {
            return MAPPER.readValue(json, BlogJSONResult.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
     ...
     */
    public static BlogJSONResult formatToList(String jsonData, Class<?> clazz) {
        try {
            JsonNode jsonNode = MAPPER.readTree(jsonData);
            JsonNode data = jsonNode.get("data");
            Object obj = null;
